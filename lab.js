...
//CODE HERE
//assigned true to lovesCode
let lovesCode = true;
//if conditional that checks for exact true or exact false
 if (lovesCode === true) {
...
if (temperature > 80 && rain === true){
  console.log("Wear a T-shirt and take an umbrella because it is raining.")
...
if (temperature > 80 && rain !== true){
  console.log("Wear a T-shirt and some shorts.")
} else if(temperature >= 60 && temperature < 80 && rain !== true){
  console.log("Wear a hoodie.")
} else if (temperature < 60 && rain !== true){
  console.log("Probably time for a coat.")
}
